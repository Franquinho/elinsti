-- Script de Base de Datos para Ferozo - El INSTI POS
-- Base de datos: c2840781_elinsti
-- Usuario: c2840781_elinsti
...
('Pizza Margherita', 3200.00, '🍕', TRUE),
('Hamburguesa Gourmet', 2800.00, '🍔', TRUE),
('Ensalada César', 2200.00, '🥗', TRUE),
('Tiramisu', 1800.00, '🍰', TRUE);
...
CREATE INDEX idx_comanda_detalle_comanda ON comanda_detalle(comanda_id);
